        ...
        <v-row class="reversing-here" v-if="tripDetail.trip_id">
          <div class="col-lg-9 col-md-12">
            <v-row class="mt-0 mb-0">
              ...
              >
                <div class="traveler-left-corner"></div>
                <div class="traveler-right-corner"></div>
                ...
                <div class="traveler-bottom-left-corner"></div>
                <div class="traveler-bottom-right-corner"></div>
              </div>
              <!--
                                ...
                                <div class="add-travel-box-top">
                                    <div class="travel-box-iner">
                                        ...
                                        <p>
                                            ...
                                            (866) 434-2226<br>
                                            7135 Gilespie Street, Las Vegas, <br>
                                            NV (NV), United States, 89119<br>
                                        </p>
                                    </div>
                                    <div class="travel-box-iner">
                                        <h5>Flight Passenger</h5>
                                    </div>
                                    <div class="travel-box-button">
                                        <v-btn class="primary"><i class="fas fa-envelope-open-text"></i> Invite To Edit</v-btn>
                                    </div>
                                </div>
                            </div>
                            -->
...
export default {
  ...
  created: function () {
    ...
    evBus.$on('addPassenger', (selectedBookingID) => {
      that.resetAddForm(0);
      that.selectedBookingID = selectedBookingID;
  ...
  methods: {
    ...
    populateAddForm: function (travelerInfo) {
      if (travelerInfo.customerType != '')
        travelerInfo.customerType = this.capitalizeFirstLetter(
          travelerInfo.customerType
        );

      if (travelerInfo.title != '')
        travelerInfo.title = this.capitalizeFirstLetter(travelerInfo.title);

      this.ckPrimaryTrv = false;
      this.traveler_id = travelerInfo.id;
      this.cusTitle = travelerInfo.title;
      ...
      this.cusType = travelerInfo.customerType;
      this.selectedBookingID = travelerInfo.selectedBookingID;
    ...
    resetAddForm: function (resetBookingID) {
      this.cdisabled = true;
      ...
      if (resetBookingID > 0) this.selectedBookingID = 0;
    ...
    submitForm: function () {
      ...
      /*
              ...
              "firstName": "Hiren",
              "lastName": "K",
              "email": "jp@mediamindmail.com",
              "mobile": "12457888",
              "address": "USA",
              "passport": "",
              "dob": "1993-05-12",      
              "age": "100",
              "details": "Car Passenger",
              "customerType":"senior"
*/
      ...
      let objTrvPayload = {
        ...
        age: this.getAge(ageDateChunks[0], ageDateChunks[1], ageDateChunks[2]),
        details: 'Car Passenger',
        customerType: this.cusType.toLowerCase(),
      };

      if (this.traveler_id >= 1) {
        objTrvPayload.travellerId = this.traveler_id.toString();
      ...
      if (this.selectedBookingID > 0) {
        reqPayLoad.bookingIds = this.selectedBookingID.toString();
      }

      travellerServices
        .addTraveller(reqPayLoad, reqHeaders)
        .then((rsp) => {
          if (
            rsp.data.success == false &&
            rsp.data.message == 'Token has expired'
    ...
    doUpdateCustomer: function (travelerInfos) {
      ...
      travelerInfos = { travellers: [travelerInfos] };
      ...
      this.appendFormdata(reqDataForm, {
        data: JSON.stringify(travelerInfos),
      });

      travellerServices
        .updateSpecTraveller(reqDataForm, reqHeaders)
        .then((rsp) => {
          if (
            rsp.data.success == false &&
            rsp.data.message == 'Token has expired'
            ...
            this.traveler_id = null;
            this.ckPrimaryTrv = false;
            this.getTripById(_tripInfo.trip_id);
          }
        })
        .catch((error) => {
          this.$awn.alert('Please try later, server encounter error..!');
