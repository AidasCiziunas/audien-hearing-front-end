        ...
        <v-row align="center">
          ...
          <div class="col-md-9 col-sm-7">
            <div class="search-heading">
              <h2>Invite to Add / Edit Travelers</h2>
            </div>
                ...
                <div class="sidebar-content">
                  <div class="agent-content">
                    <div class="in-outer">
                      ...
                      <div class="in-right">
                        <h6 v-if="tripAgent">
                          {{ tripAgent.vcFName | capitalize }}
                          {{ tripAgent.vcLName | capitalize }}
                        </h6>
                      </div>
                    </div>
                ...
                <div class="col-6">
                  <div class="add-travel-box-top">
                    ...
                    <div class="travel-box-iner">
                      <h5>
                        Status:
                        {{ paymentMethods.length ? 'Added' : 'Not Added' }}
                      </h5>
                    </div>
                    <div class="travel-box-button">
                      <v-btn class="primary" to="/customer-payment-info">
                        <i class="fas fa-envelope-open-text"></i>
                        Add Payment Info
                      </v-btn>
                    </div>
