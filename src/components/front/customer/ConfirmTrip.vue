                    ...
                    <div class="confirmation-header mt-5" style="background:#fff;" 
                        ...
                        <div class="in-left">
                            <p  >
                                ...
                                <img v-if="domain == 'uk'" :src="require('@/assets/images/atol-warning.jpg').default" class="atol-icon"/>
                                <img v-if="domain == 'ie'" :src="require('@/assets/images/topps.jpg').default" style="width:60px; height:30px"/>
                                    ...
                                    <v-expansion-panel-header>
                                        ...
                                        <div class="acord-head" v-if="item.engine=='activity'">
                                            ...
                                            <h3 v-if="typeof item.bookingData != 'undefined' && item.bookingData.success">
                                                ...
                                                Activity Booking Fee: {{ currencySymbol}}{{ item.bookingData.data.totalPrice }}
                                            ...
                                            <div class="acord-body" v-if="typeof item.bookingData != 'undefined' && item.bookingData.success">
                                                ...
                                                <v-simple-table v-if="item.bookingData.success == true">
                                                  ...
                                                  <template v-slot:default>
                                                    ...
                                                    <tr v-if="activityTravelDate">
                                                            <td>Activity Date:</td> 
                                                            <td>{{ getDateInFormat(activityTravelDate, 'ddd, MMM Do, YYYY') }}</td>
                                                    </tr>
                                                    <!-- <tr>
                                                            <td>Check In Date:</td> 
                                                    ...
                                                    <tr v-if="item.bookingData.data.booking.bookingId && item.bookingData.data.booking.bookingId != ' '">
                                                        <td>Booking ID:</td>
                                                        <td>
                                                        {{ item.bookingData.data.booking.bookingId }}
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <a
                                                          style="margin-left: 20px;"
                                                          @click="doCancelPolicyPopUp([item.bookingData.data.booking], 'activity')"
                                                        >
...
export default {
    ...
    created: function() {
       this.domain = this.$store.state.envStore.domain;
        ...
        // If true then it will make redirect to chckout step One instead of first page

        if(this.bulkedType == 'trip') // Refresh the trip data so all item of checked items can update
            this.getTripById(this.tripDetail.trip_id);
    },
    methods: {
        seeBookingData(data){
    ...
    computed: {
        ...
        currentDate(){
          return moment().format(this.fullDateFormat());
        },
        activityTravelDate(){
            try {
                return this.$store.state.ActivityStore.searchedAvailabilityData.travelDate;
            } catch (error) {
                return false;
            }
        ...
        async bookedDetailsProcess() {
            ...
            // dataKey.dummyCKFlightFalsyRspLive05
            // dataKey.dummyCKHotelFalsyRspLive6
            // dataKey.dummyCKHotelFalsyRspLive5
            // that.$store.getters.getCardDetails 
            // dataKey.dummyCKResp
            // dataKey.dummyCKHotelTrulyRspLive
            ...
            for (i = 0; i < _allBookings.length; i++) {
                ...
                if(_allBookings[i].engine=='flight') {
                    ...
                    if(_allBookings[i].bookingData.success==true) {
                        ...
                        bookObj.bookItems[i].pickLoc = (typeof location.pickLoc!="undefined") ? location.pickLoc.name.join() : '';
                        bookObj.bookItems[i].dropLoc = (typeof location.dropLoc!="undefined") ? location.dropLoc.name.join() : '';
