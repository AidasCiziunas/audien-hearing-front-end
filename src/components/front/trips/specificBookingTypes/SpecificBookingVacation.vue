<template>
  <!--Vacation booking data start here-->
    ...
    <v-card>
      <v-row>
        <v-col cols="12">
          <p>
            ...
            <span style="color: #3d4ed7"> Vacation/Tour Booking</span>
          </p>
        </v-col>
      </v-row>
      ...
      <v-row>
        <v-col cols="12" sm="4">
          ...
          <v-text-field label="ABCD" single-line></v-text-field>
        </v-col>
        <v-col cols="12" sm="4">
          <label>Tour Location</label>
          <v-text-field label="London" single-line></v-text-field>
        </v-col>
      </v-row>
  ...
  <!--Vacation booking data end here-->
</template>

<script>
export default {
  name: 'SpecificBookingVacation',
  data() {
    return {};
  },
